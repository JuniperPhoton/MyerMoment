    ...
    public class UpdateTileHelper
    {
        ...
        public async static Task<bool> UpdateTileForWindowsPhone(UIElement wideTileGrid,UIElement mediumTileGrid,UIElement smallTileGrid)
        {
            try
            {
                ...
                //var widenewTileContent = TileContentFactory.CreateTileWide310x150PeekImage05();
                //widenewTileContent.RequireSquare150x150Content = true;
                //widenewTileContent.Square150x150Content = mediumTileContent;
                //widenewTileContent.ImageMain.Src = "ms-appdata:///local/" + widename;
                //widenewTileContent.ImageSecondary.Src = "ms-appdata:///local/" + mediumname;
                //widenewTileContent.TextHeading.Text = " ";
                //widenewTileContent.Branding = TileBranding.None;
